...
public class Lotto예제 {
	...
	public static void main(String[] args) {
		 ...
		 * 로또번호 = 사용자 번호 6자리 (1~45) : 자동번호
		 * 당첨번호 = 사용자 번호 6자리+1자리(보너스번호) (1~45)
		 * 
...
//		for(int i=0; i<arr.length;i++) {
//			int r = random();
//			if(!isContain(arr,r)) {                //11
//				arr[i] = r;                        //10 11 0 0 0 0
//			} else {
//				i--;
//			}
...
//	}
   ...
   public static void printArray(int arr[]) {
	 ...
	 * 메서드명 :  isContain
	 */
	public static boolean isContain(int arr[], int random) {  //2번의 값이 들어옴
		for(int tmp : arr) {
			if(tmp == random) {
				return true;
			}
