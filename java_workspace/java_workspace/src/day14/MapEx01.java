...
public class MapEx01 {
	...
	//메서드자리
	public static void main(String[] args) {   //main만 static으로 남겨줌.
		//단어장 -> 메서드로 변경
		//단어를 입력받는 메서드 생성
...
//		}
		...
		//HashMap<String, String> map =[ new HashMap<String, String>();] -> 대가로 한부분을 ex.make3(); 로 바꿔줌.
		// 3. 번에 있는 부분
