...
public class 내부클래스 {
	...
	public static void main(String[] args) {
		...
		//외부클래스에서 내부클래스를 생성 => private으로 선언된 내부클래스는 접근 불가  (class Inclass => private class Inclass인 경우)
...
//		}
	...
	void inTest() { //정적클래스의 일반메서드
		...
		System.out.println("Outclass sNum = "+sNum+"(외부클래스의 static 변수)");
		System.out.println("Inclass sInNum = "+sInNum+"(외부클래스의 static 변수)");
		System.out.println("Inclass inNum = "+inNum+"(내부클래스의 인스턴스 변수)");
	}
		
	static void sTest() { //정적 클래스의 정적메서드
		//System.out.println("Outclass Num = "+num+"(외부클래스의 인스턴스 변수)"); //error
		System.out.println("Outclass sNum = "+sNum+"(외부클래스의 static 변수)");
		System.out.println("Inclass sInNum = "+sInNum+"(외부클래스의 static 변수)");
