...
public class 연산자 {
	...
	public static void main(String[] args) {
		...
		/* 대입연산자 : = 을 기준으로 오른쪽에 있는 값을 왼쪽에 저장 a = b 
		 ...
		 * 실수 / 정수 = 실수
		 */
		System.out.println(3 / (double) 2); // System.out.println((double)3 /2);
		...
		/*
		 * 문제. 국어 70점, 영어 35점, 수학 97점일 때 국어, 영어, 수학의 세과목의 합과 평균을 구하여 콘솔에 표시
		 *
		 */
		int x = 70;
		int y = 90;
