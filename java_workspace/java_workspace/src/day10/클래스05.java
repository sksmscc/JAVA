...
public class 클래스05 {
	...
	public static void main(String[] args) {
		/* static이 붙은 멤버 변수/메서들을 클래스 멤버/메서드 라고 한다.
		 * static이 안붙은 멤버변수. 메서드들을 객체(인스턴트) 멤버변수/메서드라고 한다.
		 * 
...
(중요)★   * - 객체 멤버 변수는 클래스 멤버 메서드에서 사용할 수 없다.
	★	 * - 객체 멤버는 객체멤버 메서드에서만 사용할 수 있다.
		 * 
		 */
		TV t = new TV();
		//객체 멤버 메서드 접근 방식 : 객체생성 후 객체명.메서드명()
		t.printPower();
		System.out.println(TV.brand);
		
		//클래스 멤버 메서드 접근 방식 : 클래스명.메서드()
		TV.printBrand();
 ...
 class TV{
	 ...
	 public final static String brand = "samsung";     //final :최종 수정할 수 없는 상수  (상수는 수정할 수 없다)
